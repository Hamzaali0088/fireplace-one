        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Our goal is to give you services that are fast, effective, and
              affordable, and that go above and beyond what you expect.
            </p>
